...
You’ll move fastest if you already know:

1. **Python & PyTorch** — comfortable training or debugging models.
2. **How transformers work** — attention, residuals, layer norm at the level of shapes and data flow (see [nanoGPT](https://github.com/karpathy/nanoGPT)).
3. **C++ basics** — enough to write arithmetic functions and follow data flow of other code,
...
## Build and run
May you never have to deal with cuda tookit / driver mismatch issue but if you do run into issues
ask your fav AI model for instructions to match driver and cuda-toolkit versions.
